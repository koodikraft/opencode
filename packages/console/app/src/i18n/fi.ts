...
export const dict = {
  ...
  "email.title": "Kuule ensimmäisenä uusista julkaisuistamme",
  ...
  "home.hero.subtitle.a": "Mukana on ilmaisia malleja, tai voit yhdistää minkä tahansa mallin miltä tahansa palveluntarjoajalta,",
  ...
  "home.what.shareLinks.body": "Jaa linkki mihin tahansa istuntoon viitteeksi tai virheiden selvittämiseen",
  ...
  "home.privacy.title": "Tietosuoja edellä rakennettu",
